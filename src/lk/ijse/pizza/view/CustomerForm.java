...
public class CustomerForm extends javax.swing.JPanel {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        System.out.println("customer update action");
        if (customerID == 0) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (txtName.getText().equals("") || txtContact.getText().equals("")) {
            ...
            if (!Validator.name(txtName)) {
                JOptionPane.showMessageDialog(this, "Input valid name...!");
            }
            if (!Validator.telephoneValidation(txtContact)) {
